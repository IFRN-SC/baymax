...
bool Sensores::bbpp(){return (maisEsqBranco()) && (esqBranco()) && (!dirBranco()) && (!maisDirBranco());} //testar
bool Sensores::ppbb(){return (!maisEsqBranco()) && (!esqBranco()) && (dirBranco()) && (maisDirBranco());} //testar
...
bool Sensores::pppb(){return (!maisEsqBranco()) && (!esqBranco()) && (!dirBranco()) && (maisDirBranco());} //testar
bool Sensores::bppp(){return (maisEsqBranco()) && (!esqBranco()) && (!dirBranco()) && (!maisDirBranco());} //testar estrategia curva
